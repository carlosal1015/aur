...
ARG PATCH="https://gist.githubusercontent.com/carlosal1015/0dfb20b96d1ab7464d3b11a2259b744d/raw/ba41b4d27cffbbcc9c3cdf8eb7d32bd4226c4c2a/0001-Add-support-for-Zoltan-Valgrind-HDF5-openmpi-OpenCL-Sundials.patch"
...
RUN yay --needed --noconfirm --noprogressbar -Syyuq && \
  ...
  curl -O ${PATCH} && \
  git am --signoff < 0001-Add-support-for-Zoltan-Valgrind-HDF5-openmpi-OpenCL-Sundials.patch && \
